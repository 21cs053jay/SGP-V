...
//         <a
//           href={data.resumeURL} // Assuming you have a URL stored for resume
//           target="_blank"
...
import axios from "axios";
import Sidebar from "./SideNavBar"; // Importing Sidebar
import DownloadResumeButton from "./downloadresume"; // Importing the DownloadResumeButton
            ...
            <tbody>
              {filteredData.map((data) => (
                <tr key={data._id} className="hover:bg-gray-100">
                  ...
                  <td className="py-2 px-4 border-b">{data.applyFor}</td>
                  <td className="py-2 px-4 border-b">
                    {/* Use DownloadResumeButton component */}
